// Golang Machine Learning currently contains several packages supporting different
// ML concepts, algorithms, and testing environments.
//
// A neural network (nn) package contains various loss functions and layers. A clustering
